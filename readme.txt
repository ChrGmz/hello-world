...
'git status': tells you the status of the folder, lets you know if there are any changes or files added. returns an error if the folder/directory is not a Git repository
